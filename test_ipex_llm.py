#!/usr/bin/env python3
"""Test IPEX-LLM inference on Intel Arc B580 GPUs"""
...
def main():
    print("=" * 60)
    print("IPEX-LLM Intel Arc B580 Inference Test")
    print("=" * 60)
    ...
    # Load model with IPEX-LLM optimizations
    ...
    start = time.time()
    # Load in sym_int4 quantization for better performance on Arc GPUs
